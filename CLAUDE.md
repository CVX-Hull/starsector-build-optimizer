...
- **Phase 5** (5A–5E complete; 5F planned; 5G deferred): Signal quality.
...
├── models.py                      # Dataclasses + enums (ShipHull, Weapon, Build, BuildSpec, CombatFitnessConfig, TWFEConfig, EBShrinkageConfig, ShapeConfig, EngineStats, etc.)
