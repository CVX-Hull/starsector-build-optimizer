...
- Quality gates (pre-commit-enforced): `uv run ruff check . && uv run ruff format --check . && uv run mypy && uv run deptry .`; Java gates run inside the Gradle build. Evidence: [2026-07-12 tooling research](docs/reports/2026-07-12-quality-tooling-research.md).
