    ...
    def test_range_coherence_uniform(self):
        ...
        gd = _game_data(
            weapons={
                ...
                "w2": _weapon("w2", range_=700, weapon_type=WeaponType.ENERGY, size=SlotSize.SMALL),
            }
        )
    ...
    def test_range_coherence_mixed(self):
        ...
        gd = _game_data(
            weapons={
                ...
                "w2": _weapon(
                    "w2", range_=1000, weapon_type=WeaponType.ENERGY, size=SlotSize.SMALL
                ),
            }
        )
        build = Build("test", {"WS1": "w1", "WS2": "w2"}, frozenset(), 0, 0)
    ...
    def test_damage_mix_balanced_better(self):
        ...
        gd_mixed = _game_data(
            weapons={
                ...
                "he": _weapon(
                    "he",
                    damage_type=DamageType.HIGH_EXPLOSIVE,
                    weapon_type=WeaponType.ENERGY,
                    size=SlotSize.SMALL,
                ),
            }
        ...
        hull = _hull()
        mixed = heuristic_score(
            Build("test", {"WS1": "kin", "WS2": "he"}, frozenset(), 0, 0), hull, gd_mixed
        )
        mono = heuristic_score(
            Build("test", {"WS1": "k1", "WS2": "k2"}, frozenset(), 0, 0), hull, gd_mono
        )
