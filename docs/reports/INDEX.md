...
| 2026-07-14 | draft | [Accounting-run stream pre-registration](2026-07-14-accounting-stream-preregistration.md) | Pre-registration + analysis ledger for the roadmap item-3 accounting run: predeclares the Tier-1/Tier-2 gate statistics, the Tier-2 oracle-coverage rank-stratified subset rule, the fresh seeds (hammerhead 100–108, wolf 120–122), and the retained-artifact manifest — committed before the stream is collected (stream-reuse discipline). Consultations append as dated ledger entries. |
