...
| Date | Report | Topic |
|---|---|---|
| 2026-05-09 | [Wave 0 validation](2026-05-09-wave0-validation.md) | V2 re-validation Wave 0 — preflight gate. All 4 gates passed post-fix; multi-worker LOADOUT_MISMATCH root-caused (commit `c2d5150`) and verified clean (200/200). Wave 1 cleared. |
...
| 2026-05-10 | [Wave 1 validation](2026-05-10-wave1-validation.md) | **Draft.** Wave 1 ablation matrix (5 cells × 3 seeds). Gate verdicts, decision-tree branch, Wave 3 cost re-forecast, LOADOUT_MISMATCH band-aid. |
| 2026-05-10 | [Wave 2 validation](2026-05-10-wave2-validation.md) | **Scaffold.** Wave 2 cross-regime warm-start + wolf frigate gates. Pre-launch — fills in after `launch_wave2.sh` completes. |
| 2026-05-10 | [Post-hoc ranker — research and Wave 1 empirics](2026-05-10-posthoc-ranker-research.md) | TWFE+EB / Bradley-Terry / raw-mean comparison on 1,744 Wave 1 trials. Raw mean has 0/5 overlap with the three principled methods. Consensus identifies `36538033d63b` (double-heavy-AC Hammerhead) as Wave 1's top pick. |
| 2026-05-10 | [Wave 1 comprehensive analysis](2026-05-10-wave1-comprehensive-analysis.md) | **Draft.** Pooled & per-cell ranker comparison (raw_mean / TWFE / TWFE+EB / BT) over 1,744 Wave 1 trials. F1c at α̂_EB returns null (CIs span 0); c1 leads c2 at training time; c3 trips F2a + has unstable per-seed ranks. 10 charts + 13 numerical sections. |
| 2026-05-10 | [Wave 1 optimization-trajectory analysis](2026-05-10-wave1-optimization-trajectory.md) | **Draft.** Per-trial trajectory diagnostics (best-so-far, sample efficiency at T ∈ {50, 100, 150, 200}, time-to-90 %, cross-seed CV, pruner & exploration trajectories) over 2,374 trial rows. Recommends Wave 3: ≥ 5 seeds, ≥ 400 trials/seed, warm-start as default. 8 charts + 12 numerical sections. |
| 2026-05-10 | [Wave 1 honest-eval stall checkpoint](2026-05-10-wave1-honest-eval-stall-checkpoint.md) | Snapshot of in-flight eval `…20260510T170431Z` at ~28 % complete. Throughput collapsed 134→2.4/min over 30 min; guardrails (a) and (b) tripped. Resume path documented (run is recoverable via `--resume-from` + teardown). |
