...
| 2026-05-12 | draft | [Phase 7 learned surrogate experiment](2026-05-12-phase7-learned-surrogate-experiment.md) | Local full learned-surrogate run completed; AWS renewable-lease smoke is infra validation only and full AWS execution is disabled pending explicit reproducibility need. |
