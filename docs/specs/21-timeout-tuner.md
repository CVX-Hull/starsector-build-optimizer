...
```
data/evaluation_log.jsonl       # Shared with Phase 8 surrogate
```
...
- Shared with Phase 8 neural surrogate (same data, no duplication)
- TimeoutTuner reads: duration, completed, hull_sizes, ship_counts
- Phase 8 reads: all fields including heartbeat_trajectory
