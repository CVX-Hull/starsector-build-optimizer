...
| [phase5e-shape-revision](./reference/phase5e-shape-revision.md) | Phase 5E — Box-Cox output warping replaces quantile rank at A3; implemented 2026-04-18. Pending re-validation under V2 loadout fix; see [reports/2026-05-10-v1-loadout-bug-invalidation.md](./reports/2026-05-10-v1-loadout-bug-invalidation.md). |
